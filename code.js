/* SETTINGS START */
const prefix = "!"
const groupID = 1252274;
const bot_token = process.env.botToken;
const rblxCookie = process.env.rblxCookie;
const officerRoleE = "Officer";
const welcomeMessage = "Welcome to Special Forces. :SF:";
const maxXP = 999;
const xpAuditLogChannelID = "597233715512344611";
const mainChatChannelID = "549828075513184258";
